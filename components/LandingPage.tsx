    ...
    const features = [
        {
            ...
            description: "Create engaging captions, tweets, and posts in seconds with advanced language models."
        },
        {
            icon: <ImageIcon className="w-6 h-6 text-blue-400" />,
            title: "AI Image Creation",
            description: "Turn your ideas into stunning visuals with our integrated image generation engine."
        },
        {
            icon: <Video className="w-6 h-6 text-purple-400" />,
            title: "AI Video & Stories",
            description: "Generate cinematic videos and narrated stories from simple text prompts or images."
        },
        {
            icon: <Zap className="w-6 h-6 text-yellow-400" />,
            title: "Instant Workflow",
            description: "Streamline your content creation process and post directly to your favorite platforms."
        }
    ];
                ...
                <div className="container mx-auto max-w-6xl text-center">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
                            The all-in-one platform to generate text, images, and videos for your social media. 
                            Stop staring at a blank screen and start creating with PostAI.
                        </p>
                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-slate-400 max-w-2xl mx-auto text-lg">
                            We&apos;ve built the most powerful AI tools into a single, seamless experience. 
                            Create, edit, and publish without ever leaving the app.
                        </p>
                    </div>
                        ...
                        <div className="flex-1">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-bold text-white mb-1">Privacy First</h4>
                                        <p className="text-slate-400">Your data and content are yours. We never use your private creations to train models.</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="mt-1 p-1 rounded-full bg-emerald-500/20 text-emerald-400">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-bold text-white mb-1">Collaborative</h4>
                                        <p className="text-slate-400">Share your drafts with your team or clients for instant feedback and approval.</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="mt-1 p-1 rounded-full bg-emerald-500/20 text-emerald-400">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-bold text-white mb-1">Always Improving</h4>
                                        <p className="text-slate-400">We update our models weekly to ensure you always have access to the latest AI tech.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-8">
                                        <div className="text-white">
                                            <p className="text-sm font-medium opacity-80 mb-1">Featured Creator</p>
                                            <p className="text-xl font-bold">&quot;PostAI changed my workflow forever.&quot;</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container mx-auto max-w-4xl">
                    <div className="p-12 md:p-20 rounded-[3rem] bg-gradient-to-br from-emerald-500 to-blue-600 text-center relative overflow-hidden">
                        <div className="relative z-10">
                            <h2 className="text-3xl md:text-5xl font-bold text-white mb-8">Ready to supercharge your content?</h2>
                            <p className="text-white/80 text-lg mb-12 max-w-xl mx-auto">
                                Join thousands of creators who are already using PostAI to build their brands. 
            ...
            <footer className="py-12 border-t border-white/5 text-center">
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-center gap-2 mb-6">
                        ...
                        <span className="text-xl font-bold text-white tracking-tight">PostAI</span>
                    </div>
